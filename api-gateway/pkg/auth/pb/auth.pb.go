// mention which version of proto are we using
...
// RegisterRequest message contains the information required to register a user.
...
// RegisterResponse message contains the response sent back after a registration attempt.
...
// LoginRequest message contains the user's login credentials.
...
// LoginResponse message contains the response sent back after a login attempt.
...
// ValidateRequest message contains the token to be validated.
...
// ValidateResponse message contains the response sent back after a token validation.
